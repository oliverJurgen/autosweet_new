            ...
            <Row>
              <table className={style.table}>
                ...
                <tr className={style.tableRow}>
                  <td colSpan="2">
                      <p>Welcome to our online store! AutoSweet and its associates
                      provide their services to you subject to the following
                      conditions. By continuing on to the website, you accept
                      these conditions. Please read them carefully.</p>
                  </td>
                </tr>
                <tr className={style.tableRow}>
                ...
                <tr className={style.tableRow}>
                  ...
                  <td>
                    ...
                    with you by e-mail or by posting notices on this site. You
                ...
                <tr className={style.tableRow}>
                  ...
                  <td>
                    ...
                    AutoSweet or its content suppliers and protected by
                    international copyright laws. The compilation of all content
                    on this site is the exclusive property of AutoSweet, with
                    copyright authorship for this collection by AutoSweet, and
                ...
                <tr className={style.tableRow}>
                  ...
                  <td>
                    ...
                    AutoSweet's, in any manner that is likely to cause confusion
                    among customers, or in any manner that disparages or
                    discredits AutoSweet. All other trademarks not owned by
                    AutoSweet or its subsidiaries that appear on this site are
                    the property of their respective owners, who may or may not
                    be affiliated with, connected to, or sponsored by AutoSweet
                    or its subsidiaries.
                  </td>
                </tr>
                <tr className={style.tableRow}>
                  ...
                  <td>
                    ...
                    personal use of this site. The license does not grant you
                    the right to download (other than page caching) or modify
                    the content, or any portion of it, except with express
                    written consent of AutoSweet. This license does not include
                    any resale or commercial use of this site or its contents:
                    any collection and use of any product listings,
                    descriptions, or prices: any derivative use of this site or
                    ...
                    without express written consent of AutoSweet. You may not
                    frame or utilize framing techniques to enclose any
                    trademark, logo, or other proprietary information
                  </td>
                </tr>
              </table>
            </Row>
